...
/**
 * <p>
 * Diese Klasse ermöglicht es, ein Composerupdate über einen Link durchzuführen.
 * Um auf die Methoden dieser Klasse zugreifen zu können, wird das
 * "update"-Recht benötigt.
 * </p>
 */
class ComposerController extends \MVC_Abstract_Controller {
	 ...
	 * durchzuführen: <i>.../wdmvc/core/composer/update</i>
	 * </p>
	 */
