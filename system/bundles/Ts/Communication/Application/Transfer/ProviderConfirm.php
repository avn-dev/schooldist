...
class ProviderConfirm implements Application
{
	...
	public function getRecipients(LanguageAbstract $l10n, Collection $models, string $channel): AddressContactsCollection
	{
		...
		foreach ($models as $model) {
			...
			$transferProvider = \Ext_TS_Inquiry_Journey_Transfer::getAllProviderConfirmMails([$model->id]);
	...
	{
		return [
			Flag\Transfer\ProviderConfirm::class
		];
	}
