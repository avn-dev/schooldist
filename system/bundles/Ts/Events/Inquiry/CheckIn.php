...
class CheckIn implements ManageableEvent, Events\InquiryEvent, TestableEvent, HasIcon, HasButtons
{
	use Dispatchable,
	...
	{
		return EventManager::l10n()->translate('Schüler hat eingecheckt');
	}
