...
class SavedEvent implements ManageableEvent, Events\InquiryEvent, TestableEvent, WebhookEvent, HasIcon
{
	use Dispatchable,
	...
	{
		return EventManager::l10n()->translate('Buchung oder Anfrage wurde gespeichert');
	}
