...
{block 'login'}
    ...
    <form action="{route name='TsAccommodationLogin.accommodation'}" method="post">
        <div>
            <input value="4" name="table_number" type="hidden">
    ...
    <a href="{route name='TsAccommodationLogin.accommodation_forgot_password'}">{'Forgot password'|L10N}</a><br>
{/block}