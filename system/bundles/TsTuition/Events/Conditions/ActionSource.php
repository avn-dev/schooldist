...
class ActionSource implements Manageable
{
	...
	{
		$label = ActionSourceEnum::from($settings->getSetting('source'))->getLabelText(EventManager::l10n());
	...
	{
		$sources = collect(ActionSourceEnum::cases())
