...
use TsWizard\Handler\Setup\Steps\TransferLocation\BlockTransferLocations;

class HasTransferLocations
{
	public function __invoke(Wizard $wizard, AbstractElement $element)
	{
		if (!$element->isDisabled()) {
			...
			if (BlockTransferLocations::entityQuery($school)->first() === null) {
				$element->disable();
			}
		}
	}
