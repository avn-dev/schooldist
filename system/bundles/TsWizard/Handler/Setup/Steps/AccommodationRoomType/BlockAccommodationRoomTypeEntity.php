...
class BlockAccommodationRoomTypeEntity extends Wizard\Structure\Block
{
	use SchoolElement;
	...
	public function getQueries(): array
	{
		...
		$entityIds = BlockAccommodationRoomTypes::entityQuery($school)
			->pluck('id')
			->prepend(0);

		return [
			new Wizard\Structure\QueryParam('roomtype_id', $entityIds)
		];
	}
