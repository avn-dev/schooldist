...
class BlockLanguageEntity extends Wizard\Structure\Block
{
	use SchoolElement;
	...
	public function getQueries(): array
	{
		...
		$entityIds = BlockLanguages::entityQuery($school)
			->pluck('id')
			->prepend(0);

		return [
			new Wizard\Structure\QueryParam('language_id', $entityIds)
		];
	}
