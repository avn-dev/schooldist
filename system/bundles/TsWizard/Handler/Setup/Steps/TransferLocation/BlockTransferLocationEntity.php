...
class BlockTransferLocationEntity extends Wizard\Structure\Block
{
	use SchoolElement;
	...
	public function getQueries(): array
	{
		...
		$entityIds = BlockTransferLocations::entityQuery($school)
			->pluck('id')
			->prepend(0);

		return [
			new Wizard\Structure\QueryParam('location_id', $entityIds)
		];
	}
