 ...
 */
class Ext_Thebing_Accommodation_Cost_Week extends Ext_Thebing_Basic {

	/**
	 * @var string
	 */
	protected $_sTable = 'kolumbus_accommodations_costs_weeks';

	/**
	 * @var string
	 */
	protected $_sTableAlias = 'kacw';
	...
	protected $_aJoinTables = [
		'schools' => [
			'table' => 'ts_accommodation_costweeks_schools',
			'foreign_key_field' => 'school_id',
			'primary_key_field' => 'accommodation_cost_week_id',
		],
	];
	...
	/**
	 * Gibt eine Liste mit Kostenwochen zurück die für alle angegebenen Schulen gültig sind.
	 *
	 * Das Array ist nach der Listensortierung ("position"-Feld) sortiert.
	 *
	...
	/**
	 * @TODO Entfernen (aber Verwendungen beachten!)
	 *
	 * {@inheritdoc}
	 */
	...
	public function getSchool() {
		...
		$sMsg = 'An accommodation cost week can be assigned to multiple schools.';
