...
class Ext_Thebing_Accounting_Gui2_Agency_Format_InvoiceOpenAmount extends Ext_Thebing_Gui2_Format_Amount {
	...
	private function calculate(array $aResultData) {
		return $aResultData['invoice_amount'] - $aResultData['invoice_payed'];
	}
