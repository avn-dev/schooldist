...
/**
 * Virtueller Block: Transfer > * > Flugnummer
 */
abstract class Ext_Thebing_Form_Page_Block_Virtual_Transfers_Abstract_Flightnumber extends Ext_Thebing_Form_Page_Block_Virtual_Transfers_Abstract {

	const TRANSLATION_TITLE = 'flightnumber';
	 ...
	 * @var string
	 */
	const INFO_TEXT_KEY = 'infotext-number';
