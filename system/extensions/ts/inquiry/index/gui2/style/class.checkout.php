...
class Ext_TS_Inquiry_Index_Gui2_Style_Checkout extends Ext_Gui2_View_Style_Abstract implements Ext_Gui2_View_Style_Index_Interface {
	...
	public function getIndexStyle($mValue, &$oColumn, &$aRowData) {
		...
		if(isset($aRowData['checkout']) && $aRowData['checkout'] !== null) {
