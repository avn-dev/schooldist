...
class Ext_TS_System_Checks_Prices_PaymentConditionDependency extends GlobalChecks {
	...
	public function executeCheck() {
		...
		$queries = [
			"ALTER TABLE `kolumbus_prices_new` DROP INDEX `idClient`",
			"ALTER TABLE `kolumbus_prices_new` ADD UNIQUE `unique` (`idSchool`, `idSaison`, `idCurrency`, `idWeek`, `idParent`, `typeParent`, `payment_condition_id`) USING BTREE",
