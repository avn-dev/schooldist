 ...
 */
class Ext_TS_System_Checks_Tuition_Course_ProgramStructure extends \GlobalChecks {
	...
	public function getDescription() {
		return 'Prepare courses for program structure';
	}

	public function executeCheck() {

		$combinationFieldExists = \DB::getDefaultConnection()->checkField('kolumbus_tuition_courses', 'combination', true);
		if(!$combinationFieldExists) {
			// 'combination' existiert nicht mehr in der Tabelle (Check ist bereits durchgelaufen, Feld wird unten umbenannt)
			return true;
		}
