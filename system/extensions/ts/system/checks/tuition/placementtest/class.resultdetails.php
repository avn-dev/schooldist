...
class Ext_TS_System_Checks_Tuition_Placementtest_ResultDetails extends GlobalChecks {

	/**
	 * @return string
	 */
	public function getTitle() {
		return 'Old placementtest result details conversion';
	}
	...
	public function executeCheck()
	{
		...
		$details = \Ext_Thebing_Placementtests_Results_Details::query()->orderBy('id', 'desc')->get();
		...
		(new Ext_TS_System_Checks_Index_Reset_Inquiry())->executeCheck();
