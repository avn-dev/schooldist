...
Object.extend(Control.Tabs.prototype,{
			...
			$A(document.getElementsByTagName('a')).each(function(a){
				if(!this.links.include(a)){
					...
					if(clean_href.substring(0,1) == '#'){
						//console.debug(this.containers);
						//console.debug(this.containers.keys());
						//console.debug(clean_href.substring(1));
	...
	setActiveTab: function(link){
		...
		if(typeof(link) == 'string'){
			...
			var sTabID = this.activeContainer.id;
...
function displayTab(sTabID)
{
	if(document.getElementById(sTabID).style.visibility && document.getElementById(sTabID).style.visibility == 'hidden')
	{
		document.getElementById(sTabID).style.visibility = 'visible';
	}
}
