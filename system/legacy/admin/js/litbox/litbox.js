...
LITBox.prototype = {
	  ...
	  if(this.options.element == null) {
		  switch(this.options.type) {
			 ...
			 case 'alert' : this.d4.innerHTML = this.mes;
				this.d.temp = this.options.func;
				this.close.temp = this.options.func;
				break;
		  ...
		  $(this.d4).insert(this.options.element);
	  }
   ...
   getWindow: function(){
	  ...
	  this.d3.appendChild(this.title);

		var iTitleWidth = (parseInt(this.options.width) - 40);
		this.title.id = 'LB_title';
		if(iTitleWidth) {
			this.title.style.width = iTitleWidth+'px';
		}
      ...
      this.close.href='#';
      this.close.innerHTML='<img id="close_img_litbox" src="/admin/media/delete.png" alt="close" title="close"/>';
	  
	  // observer 4 mouseclick to exit if user click on closeimg
	  Event.observe(this.close, 'mousedown', this.exitIfClose);

      this.d4 = document.createElement('div');
      this.d4.className='LB_content';
      this.d4.id='LB_content';
      this.d4.style.height = parseInt(this.options.height) - 41 + 'px';
   ...
   exitIfClose: function(event){
   	var element = Event.findElement(event, 'A');

	Event.stopObserving(element, 'mousedown');
   ...
   position: function(){
      ...
      this.d4.style.width = this.options.width + 'px';
      ...
      var arrayPageScroll = this.getPageScrollTop();
   	if(this.d2.offsetHeight > h - 100){
         ...
         this.d2.style.top=parseInt(this.options.top)+'px';
   		...
   		this.d2.style.height=h-89 + 'px';
   		this.d4.style.height=h-130 + 'px';
