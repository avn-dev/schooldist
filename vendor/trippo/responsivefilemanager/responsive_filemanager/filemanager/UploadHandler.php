...
class UploadHandler
{
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        // Handle t_rf_ransparency in GIF and PNG images:
        switch ($type) {
            case 'gif':
            case 'png':
                imagecolort_rf_ransparent($new_img, imagecolorallocate($new_img, 0, 0, 0));
            case 'png':
        ...
        if ($is_img)
        {
            ...
            if ( $thumbResult!==true)
            {
                if($thumbResult === false){
                    $res['files'][0]->error = t_rf_rans("Not enough Memory");
                }else{
