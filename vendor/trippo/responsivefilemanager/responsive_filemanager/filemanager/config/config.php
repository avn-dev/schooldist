...
setlocale(LC_CTYPE, 'en_US'); //correct t_rf_ransliteration
...
$config = array(
	...
	*/
	...
	//active or deactive the t_rf_ransliteration (mean convert all strange characters in A..Za..z0..9 characters)
	't_rf_ransliteration'						=> true,
